...
class _AppointmentPageState extends State<AppointmentPage> {
  ...
  List<dynamic> schedules = [
    {
      "doctor_name": "Richard Tans",
      "doctor_profile": "assets/doctor_2.jpg",
      "category": "Dental",
      "status": FilterStatus.upcoming // Removed the extra space after "status"
    },
    {
      "doctor_name": "Max Lim",
      "doctor_profile": "assets/doctor_3.jpg",
      "category": "Cardiology",
      "status": FilterStatus.complete // Removed the extra space after "status"
    },
    {
